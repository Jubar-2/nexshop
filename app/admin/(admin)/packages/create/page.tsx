            ...
            <div className="max-w-6xl mx-auto px-4">
                ...
                <div className="flex flex-col md:flex-row md:items-center justify-between gap-6 mb-8 px-1">
                    ...
                    <div className="flex gap-3">
                        ...
                        <Button onClick={handleCreate} disabled={isPending} className="bg-slate-900 hover:bg-black text-white font-black h-12 px-10 rounded-xl shadow-lg transition-all active:scale-95">
